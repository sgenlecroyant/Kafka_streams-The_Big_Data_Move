...
> 1. We will be using Java as the programming language
> 2. We will be coding so much to interfaces and abstraction for loose-coupling
> 3. We will be using both Object-Oriented programming and Functional Programming
> 4. We will be coding some threads using the Java multithreaded programming to improve performance whenever possible( when Speed is critical)

<h2 style="text-align:center; font-weight:bold">More importantly <h2>

***

### 1. We will be using some cool design patterns like BUILDER DESIGN PATTERN, SINGLETON DESIGN PATTERN, FACADE DESIGN PATTERN and MANY MORE whenever we find that we really need any, this can improve the flexibility and make our streaming application a lot more robust against FUTURE BREAKING CHANGES.

### 2. We will be doing some TDD(Test-Driven-Development) practices whenever it sounds necessary and do testing with TEST-CONTAINERS at the end of our journey.


#### <h2 style="background-color: black;color: green; font-weight: 900; font-size:2rem">The Licensing:  </h2> <hr>
